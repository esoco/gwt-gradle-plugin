...
public class GwtLibPlugin implements Plugin<Project> {
    ...
    static private final String ECLIPSE_NATURE =
        "com.gwtplugins.gwt.eclipse.core.gwtNature";

    static private final String ECLIPSE_GWT_CONTAINER =
        "com.gwtplugins.gwt.eclipse.core.GWT_CONTAINER";

    static private final String ECLIPSE_BUILDER_PROJECT_VALIDATOR =
        "com.gwtplugins.gwt.eclipse.core.gwtProjectValidator";

    static private final String ECLIPSE_BUILDER_WEBAPP_VALIDATOR =
    ...
    public void apply(Project project) {
        ...
        final GwtExtension extension = project
            .getExtensions()
    ...
    private void includeSourcesForTest(Project project) {
        ...
        SourceSet mainSourset = javaExtension
            .getSourceSets()
            .getByName(SourceSet.MAIN_SOURCE_SET_NAME);
        SourceSet testSourset = javaExtension
            .getSourceSets()
        ...
        FileCollection testClasspath = project
            ...
            .plus(project.files(
                testSourset.getAllSource().getSrcDirs().toArray()))
    ...
    private void includeSourcesToJar(Project project) {
        ...
        JavaPluginExtension javaExtension =
            project.getExtensions().getByType(JavaPluginExtension.class);
        SourceSet mainSourset = javaExtension.getSourceSets().getByName("main");
    ...
    private void initGwtEclipsePlugin(final Project project) {
        final GwtExtension gwtExtension =
            (GwtExtension) project.getExtensions().getByName(GwtExtension.NAME);
        ...
        if (project.getPlugins().hasPlugin("eclipse") &&
            ...
            project
                .getPlugins()
                .withType(GwtPlugin.class,
                    warPlugin -> eclipseProject.buildCommand(
                        ECLIPSE_BUILDER_WEBAPP_VALIDATOR));
        }
    }
}
