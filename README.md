...
* 1.3.1: Fix - Minimum Java 17 for building
* 1.3.0: Compatibility with Gradle versions 9.x
    * Minimum Gradle version 8.x
    * Gradle 9.5.0 build
    * Minimum Java ~~17~~ 25 for building, fixed in 1.3.1
...
recent GWT version (2.13.0) and the associated Eclipse plugin and the version
has been set to 1.0.0 as the current code can be considered quite stable. The
project has been renamed to `gwt-gradle-plugin` but it is not related to this
equally named but even longer
abandoned [project on GitHub](https://github.com/steffenschaefer/gwt-gradle-plugin).

## Requirements ##

* Java 17 or higher
* Gradle 8 or higher (https://gradle.org)
